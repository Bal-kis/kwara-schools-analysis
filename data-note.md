...
- the kwara ward and schools datas arrived in EPSG:4326.
- reprojected both layers from EPSG:4326 to EPSG:32631(UTM Zone 31N).
- Reason: Kwara falls within UTM zone 31N.
- Operational ward data was clipped to kwara state which is my study area.
- all layers are reprojected and saved in geopackage.
M
## Five quality checks.
- completeness: schools are more concentrated in urban ilorin than the rurals. osts of the school points and polygon arent named.This might suggest incomplete attribute data even where features exist.
- currency: GRID3 wards published june 2026, downloaded september 2026. OSM schools downloaded in september 2026.
- Positional Accuracy:points and polygon appear in reasonable locations, no obvious displacement.
- Attribute Accuracy: No mixed values found.
- Fitness for purpose: not really because 60% of most features arent named.
- problem encountered: no major problems encountered. Both layers are loaded aand reprojected cleanly.